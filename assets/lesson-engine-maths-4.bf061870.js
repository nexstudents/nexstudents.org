...
var THEMES = {
  ...
  rose: { name:"Rose",
    light:{ ground:"#F0E6EB",surface:"#F9F2F5",s2:"#E5D5DD",ink:"#241520",inkSoft:"#5E4655",inkFaint:"#8C7381",rule:"#D6C2CC",
    ...
    dark:{  ground:"#1B0F15",surface:"#26161E",s2:"#321E28",ink:"#F0E1E8",inkSoft:"#B0939F",inkFaint:"#86707B",rule:"#422A36",
            accent:"#E683B1",accentInk:"#F0A9CA",accentSoft:"rgba(230,131,177,.16)",onAccent:"#160A10",
            ctlBg:"#2E1B24",ctlInk:"#F0E2E8",ctlBorder:"#5A3848",tickNow:"#BC5A88",tickDone:"rgba(230,131,177,.28)",
            brass:"#DCBB63",band:"rgba(220,187,99,.28)",word:"rgba(220,187,99,.59)" } },

  gold: { name:"Gold",
    light:{ ground:"#EFEBE0",surface:"#F8F5EC",s2:"#E3DCC8",ink:"#221C0E",inkSoft:"#5A513C",inkFaint:"#877D66",rule:"#D4CAB0",
    ...
    dark:{  ground:"#17130A",surface:"#211B0F",s2:"#2C2415",ink:"#EEE6D2",inkSoft:"#ADA084",inkFaint:"#837760",rule:"#3B311D",
            accent:"#E0B84A",accentInk:"#EDCD78",accentSoft:"rgba(224,184,74,.16)",onAccent:"#141005",
            ctlBg:"#2A2314",ctlInk:"#EEE5D0",ctlBorder:"#54462A",tickNow:"#B38E2C",tickDone:"rgba(224,184,74,.28)",
            brass:"#8CC5E6",band:"rgba(89,180,220,.26)",word:"rgba(89,180,220,.55)" } },

  teal: { name:"Teal",
    light:{ ground:"#E3EDEC",surface:"#F0F7F6",s2:"#D1E1DF",ink:"#0F1F1E",inkSoft:"#3F5553",inkFaint:"#728886",rule:"#BACFCC",
            ...
            brass:"#8A6410",band:"rgba(196,132,24,.38)",word:"rgba(196,132,24,.68)" },
    dark:{  ground:"#0A1817",surface:"#102322",s2:"#172F2D",ink:"#DDECEA",inkSoft:"#8AA6A3",inkFaint:"#637D7A",rule:"#213D3A",
            accent:"#4FC7BE",accentInk:"#85DCD5",accentSoft:"rgba(79,199,190,.16)",onAccent:"#071312",
            ctlBg:"#132C2A",ctlInk:"#D8EAE8",ctlBorder:"#2C5451",tickNow:"#33968F",tickDone:"rgba(79,199,190,.28)",
            brass:"#E0B65C",band:"rgba(224,182,92,.3)",word:"rgba(224,182,92,.62)" } }
};
