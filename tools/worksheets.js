...
{
  slug: "complete-subjects-and-predicates", subject: "English", grade: 4, grades: [4],
...
{
  slug: "forming-compound-subjects-and-predicates", subject: "English", grade: 5, grades: [5],
...
{
  slug: "simple-subjects-and-simple-predicates", subject: "English", grade: 4, grades: [4],
...
{
  slug: "complete-subjects-and-predicates-homework", subject: "English", grade: 4, grades: [4],
...
/* 🚨 PAUL'S OWN SHEET SINCE 2026-09-21, and the first of many. He replaced the
   generated version with one he made himself: *"I created a new spelling test
   worksheet I want you to replace the old one ... I'm going to start creating
   custom worksheets for now on it will just take time."*

   So this moved from kind "blank" (generated by blankHtml from `count`,
   `bonus`, `notesLines` and friends) to kind "pdf" (his file, shipped as is).
   ⚠️ Those generator fields are GONE from this record on purpose. Leaving them
   would read as if the page were still built from them.
   🚨 NEVER RUN make-pdf.js OR make-cover.js OVER THIS. Both regenerate from a
   page; this sheet has no page to regenerate from. thumb.jpg and preview-1.jpg
   come from the PDF via tools/make-preview.py.

   What his version adds over the generated one: a real instructions block, a
   score box doubling as a sticker space, and the tie back to the cut-out
   cards, which is the flashcards sheet sitting beside this one on the shelf.
   ⚠️ It carries its own copyright line and www.NexStudents.org footer. Do not
   add a second one anywhere on the page. */
{
  slug: "weekly-spelling-test", subject: "English", grade: 3, grades: [3, 7],
  kind: "pdf", file: "weekly-spelling-test.pdf", tagline: "Weekly Test",
  ...
  contains: [
    ...
    "A bonus word on its own line, scored out of one",
    "Name, date and week number across the top",
    "A score box that doubles as a space for a sticker or a drawing",
    "Instructions on the sheet, and a Notes section for the parent",
  ],
  steps: [
    "Print one copy a week. The sheet carries no words, so the same page works for any list.",
    "Through the week, study the ten words and the bonus word. The cut-out cards on the spelling flashcards sheet are made for this.",
    "At the end of the week, say each word aloud and use it in a short sentence. Repeat it, or say it slowly by syllables, if that is what it takes.",
    "Grade it together when it is finished, and use the box by the score for a sticker, a smiley face or a drawing.",
  ],
  after: "The bonus word is worth one extra point and costs nothing when it is missed, which is the point of it: it is somewhere to try a harder word without a penalty. Use the Notes section for anything worth saying to the student, not just for marks.",
  price: "$0", buy: null, art: false, thumb: true,
},
