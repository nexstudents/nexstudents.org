...
function adMain(H){
  ...
  /* 🧒 THE PROFILE STRIP, like the top of Netflix's account menu (Paul,
     2026-09-10: "maybe at the top like add profile box"). The parent's own
     box, then Add Profile. Student boxes join between them when step 4 lands;
     until then Add Profile opens Manage Profiles, which says they are coming. */
...
/* 👨‍👩‍👧 MANAGE PROFILES - the Netflix-style student profiles (ROADMAP step 4)
   will live here. Paul: "i thought about putting it also in the side panel."
   🚨 NOT BUILT YET, AND THE VIEW SAYS SO. A row that opens nothing is a dead
   button; a row that opens an honest "coming" note is not. */
