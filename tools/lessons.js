...
const LESSONS = [
  ...
  require('./content/grade-3/english/unit-4/kinds-of-sentences'),
  require('./content/grade-4/english/unit-4/writing-good-sentences'),
  require('./content/grade-3/english/unit-4/finding-the-subject'),
  require('./content/grade-4/english/unit-4/conjunctions'),
  require('./content/grade-4/english/unit-4/fragments-and-run-ons'),
  require('./content/grade-5/english/unit-4/forming-compound-and-complex-sentences'),
  require('./content/grade-4/english/unit-4/unit-1-review'),
  require('./content/grade-2/english/unit-4/kinds-of-nouns'),
  require('./content/grade-2/english/unit-4/collective-and-compound-nouns'),
