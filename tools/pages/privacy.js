...
const privacyBody = () => `<div class="band"><div class="wrap prose policy">
  ...
  <p>You do not need an account to use most of NexStudents. An account is optional, it belongs to a parent or guardian, and students never have their own login or email address. We do not sell personal information.</p>
  ...
  <p>You do not need to create an account to use NexStudents or access most of our educational resources.</p>
  <p>If you create an account, we collect the information described under Parent Accounts and Student Profiles below.</p>
  ...
  <h2 class="mid">Parent Accounts</h2>
  <p>A parent or guardian can create a NexStudents account with their first and last name, email address, and a password.</p>
  <p>Your password is handled by our sign-in provider and stored in scrambled form. NexStudents never sees it.</p>
  <p>An account can have up to two parent profiles. Each parent can set an optional 4-number PIN that keeps students out of the parent side of the account. PINs are also stored in scrambled form.</p>
  <p>Your account also keeps your own display choices, such as your color and reading settings.</p>

  <h2 class="mid">Student Profiles</h2>
  <p>Student profiles are created by a parent, inside the parent&rsquo;s account. A student does not sign up and does not give us an email address.</p>
  <p>A student profile holds a name, a grade level, and, only if the parent chooses to add them, a birthday and whether the student is a boy or a girl. We suggest using a first name or a nickname.</p>
  <p>A student can fill in an optional About Me, such as favorite subjects, books or hobbies, and choose their own color and reading settings.</p>
  <p>When a student works through lessons, NexStudents saves their progress and scores, and the points they earn, to their profile. This is what lets their work follow them from one device to another, and lets the parents on the account see how they are doing.</p>
  <p>Student profiles, About Me answers, progress and scores are only visible to the parents on that account. We do not show them to other users, and we do not use them for advertising.</p>

  <h2 class="mid">Orders</h2>
  <p>When you check out, including for free items, we keep a record of the order: the email address used, what was ordered, the date, and the amount.</p>
  <p>We use these records to deliver your downloads, send receipts, and answer questions about an order or a refund.</p>
  <p>Paid orders are handled by our payment provider, Stripe. Card details are entered with Stripe directly, and NexStudents never sees or stores your card number.</p>
  ...
  <p>Our website is designed so that children do not need to create personal accounts to use our educational materials. Student profiles are created and managed by a parent or guardian inside the parent&rsquo;s own account, and a parent can edit or remove a student profile at any time.</p>
  ...
  <p>Like most websites, NexStudents relies on other services to keep the site running. Today these are GitHub (website hosting), Supabase (accounts, sign-in and saved progress), Resend (account emails and receipts), Stripe (payments), and Cloudflare (file delivery and security).</p>
  <p>Those providers may process limited information when necessary to provide their services to us.</p>
  <p>We do not authorize these providers to use account, student or placement exam information for their own advertising purposes.</p>
  ...
  <h2 class="mid">Scores and Progress Saved on Your Device</h2>
  ...
  <p>Without an account, this information stays in the browser on the device being used. It is not sent to NexStudents, it is not attached to a name, and we cannot see it. It is not shared between devices, and clearing your browser&rsquo;s data or using private browsing will remove it.</p>
  <p>When a student is using their profile on a signed-in account, their lesson progress and scores are also saved to that profile, as described under Student Profiles.</p>
  ...
  <h2 class="mid">Deleting Your Account</h2>
  <p>You can delete your account yourself at any time. Open your account, choose Account, then Delete Account, and confirm with your password.</p>
  <p>Deleting your account permanently removes your sign-in, every parent and student profile on the account, every PIN, and all saved progress, scores and points.</p>
  <p>Your past order records are kept, because we may need them for receipts, refunds and tax records. They are no longer connected to an account. If you sign up again later with the same email address, your past orders will appear in your new account.</p>
  <p>If you would like your order records removed as well, please <a href="/contact/">contact us</a> and we will delete them unless we are required by law to keep them.</p>
  <p>A parent can also remove a single student profile from Manage Profiles. That removes the student&rsquo;s profile, progress and scores.</p>

  <h2 class="mid">Requesting Deletion</h2>
  <p>Parents and guardians may contact us to request deletion of personal information associated with their child, their account, or a placement exam.</p>
  ...
  <p class="muted" style="margin-top:34px">Last updated: September 11, 2026</p>
