...
module.exports = {
  ...
  words: [
    ["Cell membrane", "The boundary around the outside of a cell that decides what gets in and out.", [9,10]],
    ["Cytoplasm", "The gel-like material that fills the inside of a cell.", 12],
    ["Nucleus", "The control center that directs the cell's activities.", 31],
    ["Organelle", "A structure inside the cytoplasm that does one particular job.", 39],
    ["Prokaryotic", "A cell with no membrane around its nuclear material, such as a bacterium.", 22],
    ["Eukaryotic", "A cell whose nucleus has a membrane around it, such as any plant or animal cell.", 27],
    ["Mitochondria", "The organelles where a cell releases energy from food.", 43],
    ["Chloroplast", "The green organelle in a plant cell where photosynthesis happens.", 55]
  ],
