...
module.exports = {
  ...
  words: [
    ["Selectively permeable", "Letting some substances pass through while stopping others."],
    ["Diffusion", "The movement of molecules from an area where they are crowded to an area where they are less crowded."],
    ["Equilibrium", "The point at which molecules are spread evenly and stop piling up in one place."],
    ["Osmosis", "The diffusion of water through a selectively permeable membrane."],
    ["Passive transport", "Materials moving through a cell membrane without the cell using energy."],
    ["Active transport", "Materials moving through a cell membrane that require the cell to use energy."],
    ["Endocytosis", "Taking in a particle too large to cross the membrane by folding the membrane around it."],
    ["Exocytosis", "Releasing material out of a cell by pushing it through the membrane."]
  ],
