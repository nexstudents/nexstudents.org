...
module.exports = {
  ...
  parts: [
    ...
    { title: "Food Out of the Earth", s: [
      ...
      "",
      "[verse] Psalm 104:14 says, “He causeth the grass to grow for the cattle, and herb for the service of man: that he may bring forth food out of the earth.”",
      "",
  ...
  words: [
    ["Metabolism", "The total of all the activities that keep an organism alive, growing and reproducing.", 8],
    ["Producers", "Organisms that make their own food.", 19],
    ["Consumers", "Organisms that cannot make their own food and must eat.", 13],
    ["Photosynthesis", "Using energy from sunlight to build glucose out of carbon dioxide and water, giving off oxygen.", 21],
    ["Cellular respiration", "Using oxygen to break glucose down and release the energy stored in it.", 31],
    ["Fermentation", "Releasing energy from glucose without using oxygen, which gives far less energy.", 40]
  ],
