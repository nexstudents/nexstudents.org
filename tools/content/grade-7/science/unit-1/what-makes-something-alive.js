...
module.exports = {
  ...
  parts: [
    ...
    { title: "The Amazing Design of Life", s: [
      ...
      "",
      "[verse] Genesis 1 tells us that God created the living world, and Genesis 2:7 describes God giving mankind the breath of life.",
      "",
  ...
  todo: { title: "What To Do Now", s: [
      "You have just gone through the list that separates a living thing from a rock, and it is shorter than most people expect.",
