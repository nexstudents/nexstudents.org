...
module.exports = {
  ...
  parts: [
    ...
    },
    {
      ...
      s: [
        "Last time you cut a sentence in two.",
        "Green told you who or what the sentence was about, and orange told you what was said about it.",
        "That line is still there.",
        "This time you are going inside each half to find the one word running it.",
        "",
        "Look at this sentence again.",
        "The mechanic under the left wing tightens a bolt for the third time.",
        "The whole green half is the mechanic under the left wing.",
        "But the sentence is not about a wing.",
        "It is about a mechanic, and under the left wing only tells you which one.",
        "So the simple subject is mechanic.",
        "",
        "Now the orange half.",
        "It says tightens a bolt for the third time, and only one word there is something he actually does.",
        "A bolt is a thing and for the third time is a detail.",
        "The word tightens is the simple predicate.",
        "",
        "Here is where this goes wrong most often.",
        "A student looks for a noun, finds wing sitting right next to the verb, and marks it.",
        "Ask yourself who or what the sentence is about before you pick, and that mistake disappears.",
        "",
        "One more thing you will meet later.",
        "Sometimes a verb brings a helper along, as in has tightened or is flying.",
        "When that happens the helper and the verb travel together and count as the simple predicate between them.",
    ...
    },
    {
      ...
      s: [
        ...
        "It is not.",
        "Every careful reader you will ever meet is doing this without thinking about it.",
        "",
        "A contract, a set of instructions, a warning label, a verse: each one is built out of sentences, and each sentence is built around a subject and a predicate.",
        "If you cannot see what a sentence is about and what it claims about it, you cannot judge whether the claim is true.",
        "",
        ...
        "Giving the sense means saying what it actually means, not what you assumed it meant.",
        "That is the work you are practising every time you find the subject and the verb.",
        "Read it rightly first, and then you are in a position to judge whether it is so."
      ]
    }
  ],
