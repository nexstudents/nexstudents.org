  ...
  parts: [
    ...
    },
    {
      ...
      s: [
        ...
        "Now we are going to take the sentences you just heard and pull them apart.",
        "",
        "Last time you cut a sentence into two halves.",
        "The green half told you who or what the sentence was about.",
        "The orange half told you what was being said about it.",
        "That dividing line is still there, and you still need it.",
        "This time you are going inside each of those halves to find the one word that runs it.",
        "",
        "Here is one of the sentences from the story.",
        "The mechanic under the left wing tightens a bolt for the third time.",
        "",
        "Start with the green half, which is the mechanic under the left wing.",
        "That is five words, and only one of them is the word your sentence is really about.",
        "It is not the wing.",
        "Nothing in this sentence happens to the wing.",
        "The words under the left wing are only there to tell you which mechanic we mean.",
        "So the one word at the heart of the green half is mechanic, and that is your simple subject.",
        "",
        "Now take the orange half, which is tightens a bolt for the third time.",
        "Ask yourself what the mechanic actually does.",
        "He does not do a bolt, and he does not do a third time.",
        "A bolt is the thing in his hand, and for the third time is only a detail about how often.",
        "The one word there that he does is tightens, and that is your simple predicate.",
        "",
        "After you have found both of them, run this check.",
        "Say the whole sentence again using only those two words.",
        "The mechanic tightens.",
        "It still makes sense on its own, and that is how you know you picked the right two.",
        "",
        "Next, here is where this goes wrong most often.",
        "You go looking for a noun, you spot the word wing sitting right beside the verb, and you mark it.",
        "It is an easy mistake to make, because wing really is a noun.",
        "Ask yourself who or what the whole sentence is about before you pick, and that mistake goes away.",
        "",
        "One more thing, so that it does not surprise you later.",
        "Sometimes a verb brings a helper along with it, as in has tightened or is flying.",
        "When that happens, the helper and its verb travel together, and the two of them are your simple predicate.",
    ...
    },
    {
      ...
      s: [
        ...
        "It is not.",
        "Every careful reader you will ever meet is doing this without even thinking about it.",
        "",
        "A contract, a set of instructions, a warning label, a verse: each one of them is built out of sentences, and each of those sentences is built around its subject and its predicate.",
        "If you cannot see what a sentence is about, and what it is claiming about it, then you cannot judge whether that claim is true.",
        "",
        ...
        "Giving the sense means saying what it actually means, and not what you assumed it meant.",
        "That is the work you are practicing every time you find your subject and your verb.",
        "So read it rightly first, and then you are in a position to judge whether it is so."
      ]
    }
  ],
