...
const ENGLISH = [
  ...
  require('./content/grade-3/english/unit-4/simple-subjects-and-simple-predicates'),
  require('./content/grade-4/english/unit-4/forming-compound-subjects-and-predicates'),
];
