...
const UPPER = {
  ...
  F: [S(line([L, TOP], [L, BASE])), S(line([L, TOP], [R - 6, TOP])),
      S(line([L, 70], [R - 16, 70]))],
  G: [S(arc(C, 70, 40, 60, -50, -360)), S(line([C + 40, 70], [C + 14, 70]))],
  H: [S(line([L, TOP], [L, BASE])), S(line([R, TOP], [R, BASE])),
      S(line([L, 70], [R, 70]))],
  I: [S(line([C, TOP], [C, BASE])), S(line([C - 26, TOP], [C + 26, TOP])),
  ...
  N: [S(line([L, TOP], [L, BASE])), S(line([L, TOP], [R, BASE])),
      S(line([R, TOP], [R, BASE]))],
  O: [S(arc(C, 70, 40, 60, -90, -445))],
  P: [S(line([L, TOP], [L, BASE])), S(arc(L, 43, 80, 33, -90, 90))],
  Q: [S(arc(C, 70, 40, 60, -90, -445)), S(line([C + 18, 102], [C + 46, 136]))],
  R: [S(line([L, TOP], [L, BASE])), S(arc(L, 43, 80, 33, -90, 90)),
      S(line([L + 22, 76], [R - 4, BASE]))],
  S: [S(arc(C, 40, 32, 30, -20, -270), arc(C, 100, 32, 30, -90, 160))],
  T: [S(line([C, TOP], [C, BASE])), S(line([L, TOP], [R, TOP]))],
  U: [S(line([L, TOP], [L, 100]), arc(C, 100, 48, 30, 180, 0), line([R, 100], [R, TOP]))],
