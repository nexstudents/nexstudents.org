/* ─────────────────────────────────────────────────────────────────────────
   ...
   SHAPE
     { n, title, page, bookUnit, bookUnitTitle, items: [ { label, title, page, kind, slug } ] }
...
const LIFE = {
  ...
  units: [
    /* ══ BOOK UNIT 1 — LIFE (p2) ══ */
    {
      n: 1, page: 4, title: "Exploring Life", bookUnit: 1, bookUnitTitle: "Life",
      items: [
        /* 🚨 ALL FOUR OF THESE ARE BUILT, in Paul's own words, 2026-09-03. This is
           the only complete chapter on the whole shelf. */
        { label: "1-1", title: "Living Things", page: 6, kind: "lesson",
          slug: "science/what-makes-something-alive" },
        { label: "1-2", title: "Where Does Life Come From?", page: 10, kind: "lesson",
          slug: "science/life-only-comes-from-life" },
        { label: "1-3", title: "What Is Science?", page: 13, kind: "lesson",
          slug: "science/how-we-know-what-we-know" },
        { label: "1-4", title: "Science and Society: The Impact of Science on Your Life",
    ...
    {
      n: 2, page: 28, title: "The Cell", bookUnit: 1, bookUnitTitle: "Life",
      items: [
        { label: "2-1", title: "Cells: The Units of Life", page: 30, kind: "lesson" },
        { label: "2-2", title: "Cell Structure", page: 34, kind: "lesson" },
        { label: "2-3", title: "Cell Organization", page: 44, kind: "lesson" },
        { label: "2-4", title: "Science and Society: Organ Transplants", page: 46, kind: "lesson" },
    ...
    {
      n: 3, page: 52, title: "Cell Processes", bookUnit: 1, bookUnitTitle: "Life",
      items: [
        { label: "3-1", title: "Chemistry of Living Things", page: 54, kind: "lesson" },
        { label: "3-2", title: "Cell Transport", page: 58, kind: "lesson" },
        { label: "3-3", title: "Energy in Cells", page: 63, kind: "lesson" },
        { label: "3-4", title: "Science and Society: Nondegradable Materials in Your Environment",
          page: 66, kind: "lesson" },
    ...
    {
      n: 4, page: 72, title: "Cell Reproduction", bookUnit: 1, bookUnitTitle: "Life",
      items: [
        { label: "4-1", title: "Cell Growth and Division", page: 74, kind: "lesson" },
        { label: "4-2", title: "Sexual Reproduction and Meiosis", page: 82, kind: "lesson" },
        { label: "4-3", title: "DNA", page: 86, kind: "lesson" },
        { label: "4-4", title: "Science and Society: Inventing Organisms", page: 92, kind: "lesson" },
    ...
    {
      n: 5, page: 104, title: "Heredity", bookUnit: 2, bookUnitTitle: "Heredity and Evolution",
      items: [
        { label: "5-1", title: "What Is Genetics?", page: 106, kind: "lesson" },
        { label: "5-2", title: "Genetics Since Mendel", page: 114, kind: "lesson" },
        { label: "5-3", title: "Human Genetics", page: 117, kind: "lesson" },
        { label: "5-4", title: "Science and Society: The Human Genome", page: 122, kind: "lesson" },
    ...
    {
      n: 6, page: 128, title: "Evolution", bookUnit: 2, bookUnitTitle: "Heredity and Evolution",
      items: [
        ...
        { label: "6-1", title: "Mechanisms of Evolution", page: 130, kind: "lesson" },
        { label: "6-2", title: "Evidence for Evolution", page: 136, kind: "lesson" },
        { label: "6-3", title: "Science and Society: Plant and Animal Extinction", page: 144, kind: "lesson" },
        { label: "6-4", title: "Human Evolution", page: 146, kind: "lesson" },
    ...
    {
      n: 7, page: 154, title: "Classification of Living Things", bookUnit: 2,
      bookUnitTitle: "Heredity and Evolution",
      items: [
        { label: "7-1", title: "What Is Classification?", page: 156, kind: "lesson" },
        { label: "7-2", title: "Modern Classification", page: 160, kind: "lesson" },
        { label: "7-3", title: "Science and Society: The Rain Forest Crisis", page: 164, kind: "lesson" },
        { label: "7-4", title: "Identifying Organisms", page: 166, kind: "lesson" },
    ...
    {
      n: 8, page: 180, title: "Viruses and Monerans", bookUnit: 3, bookUnitTitle: "Simple Living Things",
      items: [
        { label: "8-1", title: "Viruses: Are They Alive?", page: 182, kind: "lesson" },
        { label: "8-2", title: "Science and Society: The Cost of Curing a Disease", page: 186, kind: "lesson" },
        { label: "8-3", title: "Kingdom Monera", page: 188, kind: "lesson" },
        { label: "8-4", title: "Monerans in Your Life", page: 193, kind: "lesson" },
    ...
    {
      n: 9, page: 200, title: "Protists and Fungi", bookUnit: 3, bookUnitTitle: "Simple Living Things",
      items: [
        { label: "9-1", title: "Kingdom Protista", page: 202, kind: "lesson" },
        { label: "9-2", title: "Kingdom Fungi", page: 211, kind: "lesson" },
        { label: "9-3", title: "Science and Society: Fungus, Can't Live Without It", page: 216, kind: "lesson" },
    ...
    {
      n: 10, page: 228, title: "Introduction to Plants", bookUnit: 4, bookUnitTitle: "Plants",
      items: [
        { label: "10-1", title: "Characteristics of Plants", page: 230, kind: "lesson" },
        { label: "10-2", title: "Seedless Plants", page: 236, kind: "lesson" },
        { label: "10-3", title: "Science and Society: Peat Moss as Fuel", page: 245, kind: "lesson" },
    ...
    {
      n: 11, page: 252, title: "The Seed Plants", bookUnit: 4, bookUnitTitle: "Plants",
      items: [
        { label: "11-1", title: "Seed Plants", page: 254, kind: "lesson" },
        { label: "11-2", title: "Parts of Complex Plants", page: 259, kind: "lesson" },
        { label: "11-3", title: "Seed Plant Reproduction", page: 262, kind: "lesson" },
        { label: "11-4", title: "Science and Society: Effects of Acid Rain", page: 268, kind: "lesson" },
    ...
    {
      n: 12, page: 274, title: "Plant Processes", bookUnit: 4, bookUnitTitle: "Plants",
      items: [
        { label: "12-1", title: "Photosynthesis and Respiration", page: 276, kind: "lesson" },
        { label: "12-2", title: "Plant Responses", page: 282, kind: "lesson" },
        { label: "12-3", title: "Plant Relationships", page: 285, kind: "lesson" },
        { label: "12-4", title: "Science and Society: The Treasure of Tropical Plants", page: 288, kind: "lesson" },
    ...
    {
      n: 13, page: 300, title: "Introduction to Animals", bookUnit: 5, bookUnitTitle: "Animals",
      items: [
        { label: "13-1", title: "What Is an Animal?", page: 302, kind: "lesson" },
        { label: "13-2", title: "Science and Society: Experiments Using Animals", page: 306, kind: "lesson" },
        { label: "13-3", title: "The Simplest Invertebrates", page: 308, kind: "lesson" },
        { label: "13-4", title: "The Simple Worms", page: 315, kind: "lesson" },
    ...
    {
      n: 14, page: 322, title: "Complex Invertebrates", bookUnit: 5, bookUnitTitle: "Animals",
      items: [
        { label: "14-1", title: "Mollusks", page: 324, kind: "lesson" },
        { label: "14-2", title: "Segmented Worms", page: 327, kind: "lesson" },
        { label: "14-3", title: "Arthropods", page: 332, kind: "lesson" },
        { label: "14-4", title: "Science and Society: Pesticides", page: 340, kind: "lesson" },
        { label: "14-5", title: "Echinoderms", page: 342, kind: "lesson" },
    ...
    {
      n: 15, page: 348, title: "Cold-Blooded Vertebrates", bookUnit: 5, bookUnitTitle: "Animals",
      items: [
        { label: "15-1", title: "Fish", page: 350, kind: "lesson" },
        { label: "15-2", title: "Amphibians", page: 356, kind: "lesson" },
        { label: "15-3", title: "Science and Society: Amphibian Population Decline", page: 360, kind: "lesson" },
        { label: "15-4", title: "Reptiles", page: 363, kind: "lesson" },
    ...
    {
      n: 16, page: 370, title: "Warm-Blooded Animals", bookUnit: 5, bookUnitTitle: "Animals",
      items: [
        { label: "16-1", title: "Birds", page: 372, kind: "lesson" },
        { label: "16-2", title: "Mammals", page: 379, kind: "lesson" },
        { label: "16-3", title: "Science and Society: Saving the Manatee", page: 386, kind: "lesson" },
    ...
    {
      n: 17, page: 392, title: "Animal Behavior", bookUnit: 5, bookUnitTitle: "Animals",
      items: [
        { label: "17-1", title: "Types of Behavior", page: 394, kind: "lesson" },
        { label: "17-2", title: "Behavioral Adaptations", page: 401, kind: "lesson" },
        { label: "17-3", title: "Science and Society: Rehabilitation of Wild Animals", page: 406, kind: "lesson" },
    ...
    {
      n: 18, page: 418, title: "Bones, Muscles, and Skin", bookUnit: 6, bookUnitTitle: "The Human Body",
      items: [
        { label: "18-1", title: "The Skeletal System", page: 420, kind: "lesson" },
        { label: "18-2", title: "The Muscular System", page: 426, kind: "lesson" },
        { label: "18-3", title: "Science and Society: Drugs for Fitness?", page: 429, kind: "lesson" },
        { label: "18-4", title: "Skin", page: 430, kind: "lesson" },
    ...
    {
      n: 19, page: 440, title: "Nutrients and Digestion", bookUnit: 6, bookUnitTitle: "The Human Body",
      items: [
        { label: "19-1", title: "Nutrition", page: 442, kind: "lesson" },
        { label: "19-2", title: "Your Digestive System", page: 451, kind: "lesson" },
        { label: "19-3", title: "Science and Society: Eating Disorders", page: 456, kind: "lesson" },
    ...
    {
      n: 20, page: 462, title: "Your Circulatory System", bookUnit: 6, bookUnitTitle: "The Human Body",
      items: [
        { label: "20-1", title: "Circulation", page: 464, kind: "lesson" },
        { label: "20-2", title: "Blood", page: 471, kind: "lesson" },
        { label: "20-3", title: "Science and Society: Autologous Blood Transfusions", page: 478, kind: "lesson" },
        { label: "20-4", title: "Your Lymphatic System", page: 480, kind: "lesson" },
    ...
    {
      n: 21, page: 486, title: "Respiration and Excretion", bookUnit: 6, bookUnitTitle: "The Human Body",
      items: [
        { label: "21-1", title: "Your Respiratory System", page: 488, kind: "lesson" },
        { label: "21-2", title: "Science and Society: Dangerous Breathing", page: 496, kind: "lesson" },
        { label: "21-3", title: "Your Urinary System", page: 498, kind: "lesson" },
    ...
    {
      n: 22, page: 506, title: "Body Regulation", bookUnit: 6, bookUnitTitle: "The Human Body",
      items: [
        { label: "22-1", title: "Your Nervous System", page: 508, kind: "lesson" },
        { label: "22-2", title: "The Senses", page: 515, kind: "lesson" },
        { label: "22-3", title: "Science and Society: Alzheimer's Disease", page: 520, kind: "lesson" },
        { label: "22-4", title: "Your Endocrine System", page: 522, kind: "lesson" },
    ...
    {
      n: 23, page: 528, title: "Reproduction and Growth", bookUnit: 6, bookUnitTitle: "The Human Body",
      items: [
        ...
        { label: "23-1", title: "Human Reproduction", page: 530, kind: "lesson" },
        { label: "23-2", title: "Fertilization to Birth", page: 535, kind: "lesson" },
        { label: "23-3", title: "Development after Birth", page: 540, kind: "lesson" },
        { label: "23-4", title: "Science and Society: Sexuality", page: 544, kind: "lesson" },
    ...
    {
      n: 24, page: 556, title: "Immunity", bookUnit: 7, bookUnitTitle: "Staying Healthy",
      items: [
        { label: "24-1", title: "The Nature of Disease", page: 558, kind: "lesson" },
        { label: "24-2", title: "Your Immune System", page: 563, kind: "lesson" },
        { label: "24-3", title: "Science and Society: Preventing Disease", page: 568, kind: "lesson" },
        { label: "24-4", title: "Noncommunicable Disease", page: 570, kind: "lesson" },
    ...
    {
      n: 25, page: 578, title: "Facts about Drugs", bookUnit: 7, bookUnitTitle: "Staying Healthy",
      items: [
        { label: "25-1", title: "Drugs and Health", page: 580, kind: "lesson" },
        { label: "25-2", title: "Science and Society: Drugs in Society", page: 586, kind: "lesson" },
        { label: "25-3", title: "Problems with Illegal Drugs", page: 588, kind: "lesson" },
    ...
    {
      n: 26, page: 604, title: "Organisms and Their Environments", bookUnit: 8, bookUnitTitle: "Ecology",
      items: [
        { label: "26-1", title: "Organisms and Their Environments", page: 606, kind: "lesson" },
        { label: "26-2", title: "Biotic Relationships", page: 612, kind: "lesson" },
        { label: "26-3", title: "Abiotic Factors in the Biosphere", page: 617, kind: "lesson" },
        { label: "26-4", title: "Science and Society: Friendly Fires", page: 620, kind: "lesson" },
    ...
    {
      n: 27, page: 626, title: "Biomes", bookUnit: 8, bookUnitTitle: "Ecology",
      items: [
        { label: "27-1", title: "Factors That Affect Biomes", page: 628, kind: "lesson" },
        { label: "27-2", title: "Land Biomes", page: 632, kind: "lesson" },
        { label: "27-3", title: "Water Ecosystems", page: 637, kind: "lesson" },
        { label: "27-4", title: "Science and Society: Coastal Wetlands", page: 640, kind: "lesson" },
    ...
    {
      n: 28, page: 646, title: "Resources and the Environment", bookUnit: 8, bookUnitTitle: "Ecology",
      items: [
        { label: "28-1", title: "Natural Resources", page: 648, kind: "lesson" },
        { label: "28-2", title: "Conservation and Protection", page: 654, kind: "lesson" },
        { label: "28-3", title: "Future Responsibility", page: 658, kind: "lesson" },
        { label: "28-4", title: "Science and Society: Earth in 2030", page: 660, kind: "lesson" },
